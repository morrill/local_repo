...
mm = np.arange(0.01,2.51,0.01,dtype=float) # ration of electrical load resistance to TE module resistance
...
#plot contour of power density vs outer radius and n-type material thickness for a given m value
tnplot = tn/tw
...
plt.xlabel('Leg Length [$mm$]',fontsize=16)
plt.ylabel('m at Max Power Density',fontsize=16)
plt.ylim(mm[0], mm[-1])
